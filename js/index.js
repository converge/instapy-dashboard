...
var chart_1_y = [
  30, 25, 44, 33, 45, 40, 35, 100, 37, 20, 10, 45, 20, 48
];
var chart_2_y = [
  68, 36, 45, 50, 51, 54, 55, 65, 79, 81, 91, 92, 93, 97
];
...
$(window).on('load',function(){
    ...
    drawCircle('#chart-3',1,20,'#circle-1');
    drawCircle('#chart-4',2,53,'#circle-2');
    drawLineGraph('#chart-5', chart_2_y, '#graph-5-container', 2);
    drawLineGraph('#chart-6', chart_2_y, '#graph-6-container', 2);
    drawLineGraph('#chart-7', chart_2_y, '#graph-7-container', 2);
    drawLineGraph('#chart-8', chart_2_y, '#graph-8-container', 2);
});